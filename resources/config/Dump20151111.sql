...
--
-- Host: localhost    Database: dgs_db
-- ------------------------------------------------------
...
INSERT INTO `screen` VALUES (1,'SCRUSER','Quản lý tài khoản',1,1,'/admin/users/index.jsp',1,1,'viewUserPage'),(2,'SCRROLE','Phân quyền',1,1,'/admin/role/index.jsp',1,2,'viewRolePage'),(3,'SCRPRODUCT','Quản lý sản phẩm',3,1,'/admin/product/index',1,1,'viewManageProductPage');
...
-- Dump completed on 2015-11-11 20:48:45
